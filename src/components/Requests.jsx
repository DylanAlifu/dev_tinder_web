        ...
        return (
          <>
            <div key={fromUserId._id} className="flex justify-center">
              <div className="m-2 md:m-10 p-4 rounded-lg bg-base-300 w-[75%] md:w-[50%] flex items-center justify-around gap-8">
                ...
                <div className="flex flex-col gap-4">
                  <button className="btn btn-error btn-sm">Accept</button>
